...
//        }
        ...
        // restauration des préférences dans le onCreate()
        // Obtenir le nombre et à partir des préférences avec la clé COUNT_KEY et l'affecter à mCount
        mCount = mPreferences.getInt(COUNT_KEY, 0);
        // Mettre à jour le TextView avec le nouveau count
        mShowCountTextView.setText(String.format("%s", mCount));
     ...
     */
     ...
     /**
      * Supprimer toute la onSaveInstanceState()méthode.
      * Étant donné que l'état d'instance d'activité contient les mêmes données que les préférences
      * partagées, vous pouvez totalement remplacer l'état d'instance.
      *
      * @Override
    ...
    public void reset(View view) {
        ...
        // Réinitialiser/Effacer les préférences
        // Obtenir un éditeur
        SharedPreferences.Editor preferencesEditor = mPreferences.edit();
        // Supprimer toutes les préférences partagées
    ...
    @Override
    protected void onPause() { // Enregistrer les préférences
        super.onPause();
        // Editeur de préférences partagées
        SharedPreferences.Editor preferencesEditor = mPreferences.edit();
        // Place les entiers mCount et mColor dans les préférences partagées pour les sauvegarder
